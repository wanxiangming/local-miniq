...
<div class="row correction-row-css" style="background:rgb(33, 102, 140)">
    ...
    <div class="col-xs-offset-3 col-xs-5 text-center row form-inline" id="userInfo">
    	<a href="http://localhost/?r=Main/Main" class="btn btn-defualt col-xs-1 white"><span class="glyphicon glyphicon-home"></span></a>
        <div id="nickName" type="button" href="http://localhost/?r=Main/Test" data-toggle="tooltip" data-placement="bottom" title="加载中……" class="btn btn-defualt col-xs-1 white"><span class="glyphicon glyphicon-user"></span></div>
        <a id="logoutBtn" class="btn btn-defualt col-xs-1 white" >退出</a>
        <a id="scheduleManagerBtn" href="http://localhost/?r=Main/ScheduleManager" class="btn btn-defualt col-xs-1 white" >日程</a>
    </div>  
</div>
