...
var TableItem={
	creatNew:function(TABLE_ID,TABLE_NAME,IS_CREATOR,IS_PUBLIC,IS_ATTENTION){
		...
		var tableItemDisplay=TableItemDisplay.creatNew(tableId,tableName,isCreator,isPublic,isAttention);
		...
		(function(){
			tableItemDisplay.getUI().appendTo(div.ui);
			tableItemDisplay.onChangeName(function(TABLE_NAME){
				return e_changName(TABLE_NAME);
			});
			tableItemDisplay.onDeprecated(function(){
				return e_deprecated();
			});
			tableItemDisplay.onCancelAttention(function(){
				return e_cancelAttention();
			});
			tableItemDisplay.onOpen(function(){
				return e_open();
			});
			tableItemDisplay.onClickInherit(function(){
...
var TableItemDisplay={
	creatNew:function(TABLE_ID,TABLE_NAME,IS_CREATOR,IS_PUBLIC,IS_ATTENTION){
		...
		(function(){
			...
			tableNameScope.html(tableName+" ("+tableId+")");
			...
			if(isCreator){
				dropDown.addMenuItem(getChangeNickNameBtn_Y());
